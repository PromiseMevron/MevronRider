...
//          faceListener!!.onFaceSuccess(faces)
//      }
//        //pass the faces to the activity..............
//
//    }
    ...
    override fun onSuccess(results: List<Face>, bitmap: Bitmap, graphicOverlay: GraphicOverlay) {
        if (faceListener != null) {
            faceListener!!.onFaceSuccess(faces = results, bitmap = bitmap)
        }
    }
}

interface FaceListener {
    fun onFaceSuccess(faces: List<Face>, bitmap: Bitmap)
}
