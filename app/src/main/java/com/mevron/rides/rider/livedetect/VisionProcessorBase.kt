        ...
        return task
            .addOnSuccessListener(
                ...
                OnSuccessListener { results: T ->
                    ...
                    this@VisionProcessorBase.onSuccess(results,imageBitmap!!, graphicOverlay)
...
//            .show()
    ...
    protected abstract fun onSuccess(results: T, bitmap:Bitmap, graphicOverlay: GraphicOverlay)
